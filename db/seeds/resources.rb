...
# Helper method to create or update resources with tags
def create_or_update_resource_with_tags(attrs)
  tag_names = attrs.delete(:tag_names) || []
  resource = Resource.find_or_create_by(name: attrs[:name])
  resource.update!(attrs.except(:name))
...
puts "\nCreating/updating Exceptional resources (5)..."
exceptional_resources.each do |attrs|
  resource = create_or_update_resource_with_tags(attrs)
  if resource.created_at > 1.second.ago
    total_created += 1
  else
    total_updated += 1
  end
...
puts "\n\nCreating/updating Ultra Rare resources (5)..."
...
puts "\n\nCreating/updating Rare resources (10)..."
...
puts "\n\nCreating/updating Uncommon resources (20)..."
...
puts "\n\nCreating/updating Common resources (30)..."
...
puts "\n\n✓ Successfully processed #{total_created + total_updated} resources!"
